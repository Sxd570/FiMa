...
@tool
def get_budget_overview(user_id: str, budget_month: str):
    """
...
@tool
def get_budget_details(user_id: str, budget_month: str):
    """
...
@tool
def edit_budget_limit(user_id: str, budget_id: str, new_budget_limit: float):
    """
...
@tool
def create_budget(user_id: str, budget_limit: str, budget_name: str, budget_month: str, description: str):
    """
    ...
    """
    def _create_budget(user_id: str, budget_limit: str, budget_name: str, budget_month: str, description: str):
        try:
            api_request = APIRequest(
                http_method=APIConstants.KEY_POST_METHOD.value,
                endpoint=f"/budget/{user_id}/create",
                payload={
                    # API CreateBudgetRequest expects these keys:
    ...
    return _create_budget(user_id, budget_limit, budget_name, budget_month, description)