...
@tool
def get_goals_overview(user_id: str):
    """
...
@tool
def get_goal_details(user_id: str):
    """
...
@tool
def create_goal(user_id: str, goal_name: str, goal_description: str, goal_target_amount: float):
    """
...
@tool
def edit_goal(user_id: str, goal_id: str, goal_name: str = None, goal_description: str = None, goal_target_amount: float = None, goal_current_amount: float = None):
    """
...
@tool
def add_amount_to_goal(user_id: str, goal_id: str, amount_to_add: float):
    """
